...
export const CONFIG = {
  ...
  queenPos: { x: 22, y: 55 },
  storagePos: { x: 40, y: 46 },
  nurseryPos: { x: 57, y: 52 },
  barracksAPos: { x: 34, y: 42 },
  barracksBPos: { x: 66, y: 42 },
  digProgressPerTick: 2,
  digProgressPerTile: 8,
  dirtPerDugTile: 1,
  maxDiggers: 2,
  showUndergroundDebug: false,
  startingQueenRoomWidth: 11,
  startingQueenRoomHeight: 7,
  plannedStorageRoomWidth: 5,
  plannedStorageRoomHeight: 3,
  plannedStorageCapacity: 120,
  plannedNurseryRoomWidth: 5,
  plannedNurseryRoomHeight: 3,
  plannedNurseryCapacity: 24,
  ...
  spiderSpeed: 0.8,
  spiderChaseSpeed: 2.0,
  spiderSprintTicks: 70,
  spiderTiredSpeed: 0.7,
  spiderRecoveryTicks: 120,
